...
const Vinyl = () => {
  ...
  const benefits = [
    "Water-resistant and suitable for wet areas",
    "Affordable and budget-friendly flooring option",
    "Soft and comfortable underfoot",
    "Wide variety of colors and patterns",
    "Easy installation with peel-and-stick or roll options",
    "Ideal for kitchens, bathrooms, and utility spaces"
  ];
  ...
  const galleryImages = [
    "/images/vinyl/vinyl1.jpeg",
    "/images/vinyl/vinyl2.jpeg",
  ];
  ...
  const vinylSchema = {
    ...
    "@type": "Service",
    "name": "Vinyl Flooring",
    "description": "Affordable and stylish vinyl flooring supply and installation services in Harrow, London by Britania Flooring and Decor.",
    "serviceType": "Vinyl Flooring",
    "url": "https://britaniaflooring.co.uk/flooring/vinyl",
    "provider": {
      "@type": "LocalBusiness",
  ...
  return (
    <>
      <Helmet>
        <title>Vinyl Flooring | Britania Flooring & Decoration</title>
        <meta
          name="description"
          content="Vinyl flooring supply and installation services in Harrow, London. Affordable and stylish flooring solutions by Britania Flooring and Decor."
        />
        <script type="application/ld+json">
          {JSON.stringify(vinylSchema)}
        </script>
      </Helmet>

      <div className="bg-white min-h-screen">
        <FlooringHero title="Vinyl" image="/images/vinyl/vinyl1.jpeg" />

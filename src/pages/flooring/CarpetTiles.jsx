...
const CarpetTiles = () => {
  ...
  const benefits = [
    ...
    "Cost-effective flooring solution for large areas",
    "Excellent sound absorption and noise reduction",
    "Comfortable and warm underfoot",
    "Low maintenance with simple spot cleaning",
    "Flexible design options with mix-and-match tiles"
  ];
  ...
  const galleryImages = [
    "/images/carpet_tiles/carpet_tiles1.png",
    "/images/carpet_tiles/carpet_tiles2.png",
    "/images/carpet_tiles/carpet_tiles3.png",
    "/images/carpet_tiles/carpet_tiles4.png",
  ];

  const carpetTilesSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": "Carpet Tiles Flooring",
    "description": "Durable, flexible and cost-effective carpet tile flooring supply and installation services in Harrow, London by Britania Flooring and Decor.",
    "serviceType": "Carpet Tiles Flooring",
    "url": "https://britaniaflooring.co.uk/flooring/carpet-tiles",
    "provider": {
      "@type": "LocalBusiness",
  ...
  return (
    <>
      <Helmet>
        <title>Carpet Tiles Flooring | Britania Flooring & Decoration</title>
        <meta
          name="description"
          content="Carpet tile flooring supply and installation services in Harrow, London. Durable, flexible and cost-effective solutions by Britania Flooring and Decor."
        />
        <script type="application/ld+json">
          {JSON.stringify(carpetTilesSchema)}
        </script>
      </Helmet>

      <div className="bg-white min-h-screen">
        <FlooringHero title="Carpet Tiles" image="/images/carpet_tiles/carpet_tiles1.png" />
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
              {galleryImages.map((img, index) => (
                ...
                >
                  <img src={img} alt="Installation Showcase" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
            ...
            >
              ...
              >
                <img 
                  ...
                  className="max-w-full max-h-[80vh] md:max-h-[85vh] rounded-lg shadow-2xl object-contain" 

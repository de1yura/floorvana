...
const Tiles = () => {
  ...
  const benefits = [
    "Highly durable and long-lasting surface",
    ...
    "Low maintenance with minimal upkeep required"
  ];
  ...
  const galleryImages = [
    "/images/tiles/tiles1.png",
    "/images/tiles/tiles2.png",
    "/images/tiles/tiles3.png",
  ...
  const tilesSchema = {
    ...
    "@type": "Service",
    "name": "Tile Flooring",
    "description": "Durable and stylish tile flooring supply and installation services in Harrow, London by Britania Flooring and Decor.",
    "serviceType": "Tile Flooring",
    "url": "https://britaniaflooring.co.uk/flooring/tiles",
    "provider": {
      "@type": "LocalBusiness",
  ...
  return (
    <>
      ...
      <div className="bg-white min-h-screen">
        <FlooringHero title="Tiles" image="/images/tiles/tiles1.png" />

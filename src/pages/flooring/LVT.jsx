...
const LVT = () => {
  ...
  const benefits = [
    "Highly durable and wear-resistant surface",
    "100% waterproof and moisture-resistant",
    "Realistic wood and stone look designs",
    "Comfortable and quiet underfoot",
    "Easy installation with click or glue-down options",
  ];
  ...
  const galleryImages = [
    "/images/lvt/lvt1.jpeg",
    "/images/lvt/lvt2.jpeg",
  ];
  ...
  const lvtSchema = {
    ...
    "@type": "Service",
    "name": "LVT Flooring",
    "description": "Luxury vinyl tile (LVT) flooring supply and installation services in Harrow, London. Durable and stylish flooring solutions by Britania Flooring and Decor.",
    "serviceType": "LVT Flooring",
    "url": "https://britaniaflooring.co.uk/flooring/lvt",
    "provider": {
      "@type": "LocalBusiness",
  ...
  return (
    <>
      <Helmet>
        <title>LVT Flooring | Britania Flooring & Decoration</title>
        <meta
          name="description"
          content="Luxury vinyl tile (LVT) flooring supply and installation services in Harrow, London. Durable and stylish flooring solutions by Britania Flooring and Decor."
        />
        <script type="application/ld+json">
          {JSON.stringify(lvtSchema)}
        </script>
      </Helmet>

      <div className="bg-white min-h-screen">
        <FlooringHero title="LVT Flooring" image="/images/lvt/lvt1.jpeg" />
